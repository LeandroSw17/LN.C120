...
# Atividade 1
# Defina os valores de p1 e p2
p1 = 200  # Valor X do ponto de referência
p2 = 100  # Valor Y do ponto de referência
...
def goal_track(img, bbox):
    ...
    # Atividade 2
    cv2.circle(img, (c1, c2), 2, (0, 0, 255), 5)  # Desenha um círculo nas coordenadas (c1, c2)
...
while True:
    ...
    # Atividade 3
    goal_track(img, bbox)  # Chama a função para rastrear a bola
